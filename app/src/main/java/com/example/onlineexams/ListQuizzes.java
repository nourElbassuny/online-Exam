...
public class ListQuizzes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (solvedQuizzes) {
            ValueEventListener listener = new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(ListQuizzes.this, "Can't connect", Toast.LENGTH_SHORT);
                }
            };
            ...
            ValueEventListener listener = new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    for (DataSnapshot f : ds.getChildren()) {
                        ...
                        String points = snapshot.child("Quizzes").
                                child(quizID).child("Answers").child(f.getKey()).
                                child("Points").getValue().toString();
        ...
        android.widget.ListAdapter listAdapter = new ListAdapter(data);
